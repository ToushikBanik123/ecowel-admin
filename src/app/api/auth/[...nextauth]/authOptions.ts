// @ts-ignore
import {NextAuthOptions,User as AuthUser,Session as NextAuthSession} from "next-auth";
// @ts-ignore
  ...
  providers: [
    CredentialsProvider({
      ...
      async authorize(credentials) {
        ...
        try {
          console.log("Credentials received:", credentials, process.env.NEXTAUTH_SECRET);
  ...
  callbacks: {
    ...
    async session({ session, token }) {
      ...
      if ((token as CustomToken).user) {
        ...
        console.log("Session userExists:", userExists);
