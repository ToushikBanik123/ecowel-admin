...
import AdditionalFieldsForm from "../../AddDigitalProduct/AdditionalFieldsForm";
...
const EditDigitalProduct: React.FC<EditDigitalProductProps> = ({
    ...
    const fetchProductDetails = async () => {
      try {
        ...
        setGeneralFormState({
          ...
          dailyRitual: product.dailyRitual,
          ingredientHighlights: product.ingredientHighlights,
          bannerImage1: product.bannerImage1 ?? '',
          bannerImage2: product.bannerImage2 ?? '',
          bannerImage3: product.bannerImage3 ?? '',
          productStories: product.productStories ?? { theStoriesTitle: '', theInspireUsPrefix: '', theInspireUsWord: '', theInspireUsSuffix: '', stories: [] },
          certifications: product.certifications ?? [],
          whyItWorksTitle: product.whyItWorksTitle ?? '',
          theSecretInsideTitle: product.theSecretInsideTitle ?? '',
          theSecretInsideSubtitle: product.theSecretInsideSubtitle ?? '',
          theSecretInsideSuffix: product.theSecretInsideSuffix ?? '',
          whatMakesStandOutPrefix: product.whatMakesStandOutPrefix ?? '',
          whatMakesStandOutSuffix: product.whatMakesStandOutSuffix ?? '',
          letsUnveilPrefix: product.letsUnveilPrefix ?? '',
          letsUnveilSuffix: product.letsUnveilSuffix ?? '',
          everyScoopPrefix: product.everyScoopPrefix ?? '',
          nothingButTheBestText: product.nothingButTheBestText ?? '',
          draft: product.draft ?? false,
          purposeAndTrust: product.purposeAndTrust ?? {},
        });
  ...
  //  console.log("user session on edit page ", user)
      ...
      <Container fluid>
        <Row className="product-adding">
          ...
          <Col xl="6">
            <div className="card mb-3">
              <div className="card-body">
                ...
                <FormGroup>
                  <Label className="col-form-label pt-0">Product Status</Label>
                  <div className="m-checkbox-inline mb-0 custom-radio-ml d-flex gap-4 radio-animated">
                    <Label className="d-block">
                      <Input
                        className="radio_animated"
                        ...
                        name="draft"
                        value="true"
                        checked={generalFormState?.draft === true}
                        onChange={() => handleGeneralForm("draft", true)}
                      />
                      Draft
                    </Label>
                    <Label className="d-block">
                      <Input
                        ...
                        name="draft"
                        value="false"
                        checked={generalFormState?.draft === false}
                        onChange={() => handleGeneralForm("draft", false)}
                      />
                      Live
                    </Label>
                  </div>
          ...
          <AdditionalFieldsForm
            ...
            onUpdate={(feild, data) => handleGeneralForm(feild, data)}
          />
